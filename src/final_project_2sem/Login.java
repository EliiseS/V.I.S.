...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfUserName.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N

        jLabel3.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        jLabel3.setText("Password:");

        tfPassword.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N

        bLogin.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
    ...
    private void bLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLoginActionPerformed
        ...
        try {
            String sql = "SELECT * FROM villa_watt_inventory.users WHERE UserName = ? AND Password = ?";
